...
<form name="frmCreateProduct" id="frmCreateProduct" method="post" action="{{ route('backend.products.store') }}" enctype="multipart/form-data">
  {{ csrf_field() }}
  ...
  <div class="form-group">
    ...
    <input type="checkbox" id="discontinued" name="discontinued" aria-describedby="discontinuedHelp">
  </div>
  <div class="form-group">
